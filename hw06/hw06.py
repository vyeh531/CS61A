...
class Coin:
    ...
    def worth(self):
        ...
        #for each year of age beyond 50. A coin's age can be determined by subtracting 
        #the coin's year from the present_year class attribute of the Mint class.
        if self.year == Mint.present_year:
            return self.cents
        else:
            return self.cents + 1 * (Mint.present_year - self.year - 50)
