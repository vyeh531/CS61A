...
class Frame:
    ...
    def define(self, symbol, value):
        ...
        # BEGIN PROBLEM 1
        "*** YOUR CODE HERE ***"
        self.bindings[symbol] = value  # use dictionary method to store value, key = symbol/ value = value
        # END PROBLEM 1
    ...
    def lookup(self, symbol):
        ...
        # BEGIN PROBLEM 1
        "*** YOUR CODE HERE ***"
        if symbol in self.bindings:         # if the symbol is in the dictionary, return the value
            return self.bindings[symbol]
        elif self.parent:                   # if the symbol is not in the dic but in other frame, return the value
            return self.parent.lookup(symbol)
        # END PROBLEM 1
        raise SchemeError('unknown identifier: {0}'.format(symbol)) # if there is no match key, return error
